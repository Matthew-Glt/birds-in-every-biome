# Builds the mod. Output: build\libs\birds-in-every-biome-<version>.jar
# Needs a JDK 25 for the build; this finds one (JAVA_HOME first, then the usual install locations).
